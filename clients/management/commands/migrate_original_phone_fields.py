...
class Command(BaseCommand):
    help = 'Copia los valores actuales de phone_number y area_code a los campos originales en Client y PhoneNumberClient.'
    ...
    def handle(self, *args, **options):
        ...
        for client in Client.objects.all():
            ...
            if not client.original_area_code:
                ...
                changed = True
            if changed:
                client.save(update_fields=['original_phone_number', 'original_area_code'])
                updated_clients += 1
        ...
        for phone in PhoneNumberClient.objects.all():
            ...
            if not phone.original_area_code:
                ...
                changed = True
            if changed:
                phone.save(update_fields=['original_phone_number', 'original_area_code'])
                updated_phones += 1
